...
public abstract class BaseDialog<T extends BaseDialog<T>> extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMaxHeight = mDisplayMetrics.heightPixels - QMUIStatusBarHelper.getStatusbarHeight(mContext);
        // mMaxHeight = mDisplayMetrics.heightPixels;
        Log.e(TAG, "onCreate: mMaxHeight = " + mMaxHeight);
...
//        mLlControlHeight.addView(mOnCreateView);
        mLlControlHeight.addView(mOnCreateView, new ViewGroup.LayoutParams(mDisplayMetrics.widthPixels, (int) mMaxHeight));
...
//            height = ViewGroup.LayoutParams.MATCH_PARENT;
        ...
        Log.e(TAG, "onAttachedToWindow: mHeightScale = " + mHeightScale + " height = " + height);
    ...
    public T heightScale(float heightScale) {
        ...
        Log.e(TAG, "heightScale: heightScale = " + heightScale + " mHeightScale = " + mHeightScale);
        return (T) this;
    }
