...
public class SnapActivity extends BaseActivity {
	...
	public static final String TAG = SnapActivity.class.getSimpleName();
	...
	public static void start(Context context) {
		Intent starter = new Intent(context, SnapActivity.class);
	...
	public void initView() {
		...
		if (params instanceof AppBarLayout.LayoutParams) {
			((AppBarLayout.LayoutParams) params).setScrollFlags(AppBarLayout.LayoutParams.SCROLL_FLAG_SCROLL | AppBarLayout.LayoutParams.SCROLL_FLAG_SNAP);
		}
		mAdapter = new SimpleAdapter(SnapActivity.this);
		recyclerView.setAdapter(mAdapter);
		recyclerView.setLayoutManager(new LinearLayoutManager(SnapActivity.this));
